...
> 💡 **New to cross-server?** Check the [Cross-Server FAQ](../support/faq.md#🌐-cross-server) for beginner-friendly explanations:
> - How does it work? (One mod for multiple servers?)
> - Is setup out-of-the-box or complex?
