...
CobbleRanked does not include a built-in web API server. For building external websites and APIs, see [API & Integration](/docs/cobbleranked/advanced/api/) for code examples and security guidelines.

---

## See Also

- [API & Integration](/docs/cobbleranked/advanced/api/) - Web application examples
