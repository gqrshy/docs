import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, r as renderTemplate, U as UnknownContentCollectionError, e as renderUniqueStylesheet, f as renderScriptElement, g as createHeadAndContent, a as renderComponent, h as createAstro, d as addAttribute, i as renderScript, m as maybeRenderHead, j as renderSlot, k as renderTransition, b as renderHead } from '../../chunks/astro/server_348rjAom.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('../../chunks/_astro_data-layer-content_DfqNbX8H.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('../../chunks/_astro_assets_b_IT1Dkx.mjs').then(n => n._);
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Web API", href: "/docs/cobbleranked/configuration/api/" }
          ]
        },
        {
          label: "Integration",
...
const $$DocLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="ja"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/png" href="/gashistudios.png"><meta name="description"', "><title>", ' - GashiStudios</title><!-- Open Graph / Discord Embed --><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta property="og:site_name" content="GashiStudios"><!-- Twitter Card (summary = small thumbnail on left) --><meta name="twitter:card" content="summary"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:image"', '><!-- Theme Color (Discord embed sidebar) --><meta name="theme-color" content="#7c3aed"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">', "", "</head> <body> ", " ", ' <div class="doc-wrapper"> <main class="doc-main"> <article class="doc-content"', '> <header class="doc-header"> <h1 class="animated-doc-title" id="doc-title"', ">", "</h1> ", ' </header> <div class="prose"> ', " </div> </article> ", ` </main> <footer class="doc-footer"> <div class="footer-container"> <div class="footer-links"> <div class="footer-column"> <h4>Products</h4> <a href="/docs/cobbleranked/">CobbleRanked</a> <a href="/docs/gashilibs/">GashiLibs</a> <a href="/docs/maillib/">MailLib</a> </div> <div class="footer-column"> <h4>Legal</h4> <a href="/terms">Terms & Conditions</a> </div> <div class="footer-column"> <h4>Community</h4> <a href="https://discord.gg/VVVvBTqqyP" target="_blank">Discord</a> <a href="https://github.com/gqrshy" target="_blank">GitHub</a> </div> </div> </div> <div class="footer-bottom"> <p>&copy; 2026 GashiStudios. All rights reserved.</p> <p class="footer-disclaimer">Not affiliated with Microsoft, Mojang AB, or Minecraft.</p> </div> </footer> </div> <script>
		...
		// Image Lightbox functionality (singleton pattern with event delegation)
		(function initLightbox() {
			...
			if (!lightbox) {
				...
				// Close handlers (only register once)
				...
				// Event delegation - handle clicks on any .prose img
			...
			// Style images (run on every page load)
			...
			// Re-style on View Transitions
			if (!window._lightboxRegistered) {
				window._lightboxRegistered = true;
				document.addEventListener('astro:page-load', styleImages);
			}
		})();
