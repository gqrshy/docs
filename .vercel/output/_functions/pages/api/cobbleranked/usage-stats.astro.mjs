import { c as connectToDatabase } from '../../../chunks/mongodb_CZiyb893.mjs';
export { renderers } from '../../../renderers.mjs';

const prerender = false;
const API_KEY = process.env.COBBLERANKED_API_KEY || "";
                ...
                species: [
                  {
                    ...
                    usagePercent: 32.58,
                    count: 48,
                    moves: { "Ivy Cudgel": 100, "Horn Leech": 78.55, "Swords Dance": 75.88, "Superpower": 34.48, "U-turn": 30.41 },
                    items: { "Wellspring Mask": 100 },
                    abilities: { "Water Absorb": 100 },
